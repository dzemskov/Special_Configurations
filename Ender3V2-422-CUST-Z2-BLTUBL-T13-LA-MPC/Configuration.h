...
#define STRING_CONFIG_H_AUTHOR "Dmytro Zemskov (dzemskov)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender3V2-422-CUST-Z2-BLTUBL-T13-LA-MPC"
...
#define Z2_DRIVER_TYPE TMC2208_STANDALONE  // Custom hardware modification - reused extruder (E0) driver
...
#define E0_DRIVER_TYPE TMC2209_STANDALONE  // Custome hardware modification - extra driver connected via debug pins
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, -41, 0 }  // Sprite Extruder BLTouch offset
...
#define INVERT_Z2_DIR true  // Same as Z
